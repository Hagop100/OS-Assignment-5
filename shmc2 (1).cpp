...
sem_t *sem; //declaring semaphore pointer variable
//function prototypes
...
int main(int argc, char* argv[])
{
     ...
     //retrieving already created semaphore named "SEMAPHORE"
     sem = sem_open("SEMAPHORE", O_CREAT);

     //sem_open will return SEM_FAILED if it was unable to retrieve it
